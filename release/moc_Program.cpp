...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Program_t, stringdata) + ofs \
...
const QMetaObject Program::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Program.data,
      qt_meta_data_Program,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Program.stringdata))
